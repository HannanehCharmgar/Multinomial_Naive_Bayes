...
بردارسازی متن یعنی تبدیل متن‌ها به یک **نمایش عددی** تا مدل(Naive Bayes) بتواند روی آن‌ها کار کند، چون الگوریتم‌ها نمی‌توانند مستقیم روی متن‌ها عملیات ریاضی انجام دهند.
...
پس CountVectorizer تعداد هر کلمه را می‌شمارد و بردار می‌سازد.
