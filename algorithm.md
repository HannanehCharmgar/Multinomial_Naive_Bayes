بسیار خوب، من جزوه را به صورت کامل و با جزئیات ریاضی لازم، در فرمت **Markdown** برای شما آماده می‌کنم. این جزوه کاملاً بر اساس محتوای ویدیوی آموزشی **Multinomial Naive Bayes** است.
